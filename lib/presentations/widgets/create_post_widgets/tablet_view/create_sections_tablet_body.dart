...
class AddSectionTablet extends StatefulWidget {
  final int index;
  const AddSectionTablet({super.key, required this.index});

  @override
  State<AddSectionTablet> createState() => _AddSectionTabletState();
}

class _AddSectionTabletState extends State<AddSectionTablet> {
