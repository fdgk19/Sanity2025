...
class AddSectionDesktop extends StatefulWidget {
  final int index;
  const AddSectionDesktop({super.key, required this.index});

  @override
  State<AddSectionDesktop> createState() => _AddSectionDesktopState();
}

class _AddSectionDesktopState extends State<AddSectionDesktop> {
    ...
    return AlertDialog(
        ...
        content: Container(
            ...
            constraints: const BoxConstraints(
                // maxHeight: 800, maxWidth: 870, minHeight: 70, minWidth: 870
                minHeight: 70,
                maxHeight: 900,
                minWidth: 1000,
                maxWidth: 1000),
