...
class EditSectionMobile extends StatefulWidget {
  final int index;
  const EditSectionMobile({super.key, required this.index});

  @override
  State<EditSectionMobile> createState() => _EditSectionMobileState();
}

class _EditSectionMobileState extends State<EditSectionMobile> {
